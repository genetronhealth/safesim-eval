...
echo "source ${init} WES
bash ${scriptdir}/safemut_eval.sh -n ${outdir}/nbam/${n}.bam -v ${simfiles}/wes_simmut_safemut.vcf.gz -r ${simfiles}/wes_simmut.bed -s ${n} -o ${outdir}/safemut/${n}
...
echo "source ${init} WES
bash ${scriptdir}/varben_eval.sh -n ${outdir}/nbam/${n}.bam -v ${simfiles}/wes_simmut_varben.tsv -r ${simfiles}/wes_simmut.bed -s ${n} -o ${outdir}/varben/${n}
...
echo "source ${init} WES
bash ${scriptdir}/bamsurgeon_eval.sh -n ${outdir}/nbam/${n}.bam -s ${simfiles}/wes_simmut_bamsurgeon_snv.tsv -i ${simfiles}/wes_simmut_bamsurgeon_indel.tsv -r ${simfiles}/wes_simmut.bed -S ${n} -o ${outdir}/bamsurgeon/${n}
